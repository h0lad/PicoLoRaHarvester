...
#else
  /* RAK3172: initialize the module-internal RF switch control pins. */
...
#else
  /* RAK3172: de-initialize the module-internal RF switch control pins. */
  int32_t retcode = 0;
...
#else
  /* RAK3172: drive the module-internal RF switch (PB8 / PC13). */
  int32_t retcode = 0;
...
#else
  /* RAK3172 uses the RFO_HP output only. */
...
#else
  /* RAK3172 max output power: 22 dBm on RFO_HP, 15 dBm on RFO_LP. */
  int32_t ret = 0;
